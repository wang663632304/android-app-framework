...
class UpdateDialog extends BaseDialog {
	...
	private void initView() {
		this.handler = new PctHandler(UpdateDialog.this);
		
		final View layout = LayoutInflater.from(getContext()).inflate(ResourceUtils.getLayoutId("app_dialog_update_layout"), null);
		this.msgText = (TextView) layout.findViewById(ResourceUtils.getId("dialog_message"));
		this.pctText = (TextView) layout.findViewById(ResourceUtils.getId("pct_message"));
		this.pb = (ProgressBar) layout.findViewById(ResourceUtils.getId("pct_progressbar"));

		this.msgText.setText(ResourceUtils.getStringId("downloading_text"));
		this.pb.setMax(100);
...
class PctHandler extends Handler {
	private UpdateDialog updateDialog = null;

	public PctHandler(UpdateDialog updateDialog) {
	...
	public void handleMessage(Message msg) {
		...
		if (this.updateDialog != null) {
			this.updateDialog.handleMessage(msg);
		}
	}
}
